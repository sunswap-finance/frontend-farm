...
import { Heading } from '@sunswap/sunswap-finance-uikit'
  ...
  const farmsList = useCallback(
    (farmsToDisplay, removed: boolean) => {
      ...
      const farmsToDisplayWithAPY: FarmWithStakedValue[] = farmsToDisplay.map((farm) => {
        ...
        //   return farm
        // }
        const cakeRewardPerBlock = new BigNumber(farm.sunPerBlock || 1)
  ...
  return (
    <Page>
      <Heading as="h1" size="lg" color="primary" mb="10px" style={{ textAlign: 'center' }}>
        {tokenMode
          ? TranslateString(10002, 'Stake tokens to earn SUN')
          : TranslateString(320, 'Stake LP tokens to earn SUN')}
      </Heading>
      <Heading as="h2" color="secondary" mb="20px" style={{ textAlign: 'center' }}>
        {TranslateString(10000, 'Deposit Fee will be used to buyback SUN')}
      </Heading>
